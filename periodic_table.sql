...
--
-- Name: elements uniquect_const; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uniquect_const UNIQUE (symbol);


--
-- Name: elements uniquectm_const; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
